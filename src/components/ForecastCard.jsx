...
function ForecastCard({ item }) {
  return (
    <article className="rounded-3xl border border-white/35 bg-white/55 p-4 text-center transition hover:-translate-y-1 hover:bg-white dark:border-slate-700 dark:bg-slate-950/45 dark:hover:bg-slate-900">
